...
final class ListCurrenciesTableCell: UITableViewCell {
    
    static let id = String(describing: ListCurrenciesTableCell.self)
...
extension ListCurrenciesTableCell {
    ...
    func setViewModel(_ model: ResponseCurrencyModel) {
        ...
        self.setImageForFavoriteImageView(bool: model.isFavorite)
    }
}
...
private extension ListCurrenciesTableCell {
    ...
    func setImageForFavoriteImageView(bool: Bool) {
        if bool {
